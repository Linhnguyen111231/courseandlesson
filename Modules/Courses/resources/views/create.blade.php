...
@section('content')
    <div id="course">
        <div class="flex h-screen overflow-hidden">
            ...
            <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
                ...
                <course :website-name="'Create New Course'" :page-name="'Create'" :skills="{{$skills}}"/>
                {{-- <main>
                    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                        <section class=" dark:bg-gray-900">
                            <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
                                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Create New Course</h2>
                                <form action="#">
                                    <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                                        ...
                                        <div>
                                            <label for="item-weight"
                                                ...
                                                course completion time (hours)</label>
    ...
    <script src="{{mix('js/assets/admin/courses/app.js')}}"></script>
@endsection
